  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the excitement of Skyward, the innovative new casino game, now available at Bet.co.za. Explore a world of thrilling gameplay and discover other Evolution Gaming and Bet Games products."
        />
        ...
        {/* Don't forget other essential meta tags like robots and author */}
      </Head>
      {/* Page content */}
    </div>
  );
